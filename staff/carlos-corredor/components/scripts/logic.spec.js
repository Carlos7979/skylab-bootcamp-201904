...
describe('logic', function () {
    ...
    describe('register', function () {
        ...
        it('should fail on passing the same email', function () {
            
            
            expect(function () {
                logic.register(name, surname, email , password);
                logic.register(name, surname, email , password);
            }).toThrowError(TypeError, 'This user mail already exists');
        });
    ...
    describe('search ducks', function(){
        ...
        it('should fail if query is undefined', function(){
            expect(function(){
        ...
        it('should fail if calback is not a function', function(){
            expect(function(){
